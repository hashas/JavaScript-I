...
// console.log("here" + Object.entries(inventory)[32]);
...
console.log(Object.values(lastCar)[1], Object.values(lastCar)[2]);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
// let carModels = Object.values(inventory).forEach(item => {
//   console.log(item);
// });
let carModels = [];
