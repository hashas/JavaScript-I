...
const intern2 = {
  ...
  gender: "M",
  speak: () => "Hello my name is " + intern2.name,
}
...
// I couldn't make the above work with arrow functions so resorted to function declaration but using 'this' keyword as requested
